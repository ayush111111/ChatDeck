...
class TestCompleteFlashcardFlow:
    ...
    def test_complete_user_workflow(self, integration_client):
        ...
        sync_data = {"user_id": user_id, "flashcard_ids": flashcard_ids_to_sync}
    ...
    def test_multi_user_isolation(self, integration_client):
        ...
        bob_flashcards = {
            ...
            "flashcards": [
                {"user_id": user_bob, "front": "Bob's question 1", "back": "Bob's answer 1"},
                {"user_id": user_bob, "front": "Bob's question 2", "back": "Bob's answer 2"},
            ],
        }
        ...
        alice_sync = integration_client.post(
            "/api/v1/flashcards/sync", json={"user_id": user_alice, "flashcard_ids": [alice_fc_id]}
        )
    ...
    def test_error_handling_in_workflow(self, integration_client):
        ...
        invalid_sync = {"user_id": user_id, "flashcard_ids": [99999, 88888]}  # Non-existent IDs
    ...
    def test_large_batch_creation(self, integration_client):
        ...
        batch_data = {"user_id": user_id, "source_url": "https://example.com/large-course", "flashcards": flashcards}
        ...
        sync_response = integration_client.post(
            "/api/v1/flashcards/sync", json={"user_id": user_id, "flashcard_ids": ids_to_sync}
        )
        assert sync_response.status_code == 200
