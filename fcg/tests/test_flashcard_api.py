...
from fcg.services.database import DatabaseService
...
class TestFlashcardAPI:
    ...
    def test_sync_flashcards(self, client):
        ...
        # Create flashcards
        flashcard1_response = client.post("/api/v1/flashcards/", json={
            "user_id": user_id,
            "front": "Sync Question 1",
            "back": "Sync Answer 1"
        })
        flashcard2_response = client.post("/api/v1/flashcards/", json={
            "user_id": user_id,
            "front": "Sync Question 2",
            "back": "Sync Answer 2"
        })
        ...
        sync_data = {
            "user_id": user_id,
            "flashcard_ids": [flashcard1_id, flashcard2_id]
        }
    ...
    def test_get_user_stats(self, client):
        ...
        flashcard1_response = client.post("/api/v1/flashcards/", json={
            "user_id": user_id,
            "front": "Stats Question 1",
            "back": "Stats Answer 1"
        })
        flashcard2_response = client.post("/api/v1/flashcards/", json={
            "user_id": user_id,
            "front": "Stats Question 2",
            "back": "Stats Answer 2"
        })
        flashcard3_response = client.post("/api/v1/flashcards/", json={
            "user_id": user_id,
            "front": "Stats Question 3",
            "back": "Stats Answer 3"
        })
        ...
        sync_data = {
            "user_id": user_id,
            "flashcard_ids": [flashcard1_response.json()["id"]]
        }
    ...
    def test_mark_flashcard_failed(self, client):
        ...
        # Create flashcard
        flashcard_response = client.post("/api/v1/flashcards/", json={
            "user_id": user_id,
    ...
    def test_user_isolation(self, client):
        ...
        client.post("/api/v1/flashcards/", json={
            "user_id": user1,
